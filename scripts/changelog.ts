...
arr = futureChangelog
  ...
  .map((line) =>
    line.startsWith('[Unreleased]')
      ? `[Unreleased]: https://github.com/Dexare/Voltare/compare/v${currentVersion}...HEAD`
      : line
  );
...
const lastLine = `[${currentVersion}]: https://github.com/Dexare/Voltare/compare/v${lastVersion}...v${currentVersion}`;
