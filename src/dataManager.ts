...
/** A data manager for Voltare. */
export default class DataManager {
  /** The options for this manager. */
  readonly options: DataManagerOptions;
  /** The logger for the manager. */
  readonly logger: LoggerHandler<VoltareClient<any>>;
  /** The Voltare client for this manager. */
  ...
  constructor(client: VoltareClient<any>, options: DataManagerOptions) {
    this.options = options;
    this.client = client;
    this.logger = new LoggerHandler<VoltareClient<any>>(this.client, this.options.name);
  }
